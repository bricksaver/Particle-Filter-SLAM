...
def compute_stereo():
  ...
  for i in range(len(stereo_timestamps)):
    path_l = 'data/stereo_images/stereo_left/%s' % str(stereo_timestamps[i])
    path_r = 'data/stereo_images/stereo_right/%s' % str(stereo_timestamps[i])
    ...
    plt.imsave('data/stereo_images/disparity_images/%s' % stereo_timestamps[i], disparity)
